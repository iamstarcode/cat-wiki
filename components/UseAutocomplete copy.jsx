...
export default function UseAutocomplete(props) {
  ...
  return (
    <div>
      <div className="relative w-max text-gray-600 mt-3 mb-3" {...getRootProps()}>
        <input placeholder="Enter breed" className="max-w-xs bg-white text-black h-10 px-5 pr-10 rounded-full" type="text" {...getInputProps()} />
