    ...
    <div className="flex flex-col items-center justify-center py-2">
      ...
      <div className="flex w-full flex-col">
          ...
          <div className="flex-col text-white mt-3 px-8 py-4 md:mt-5 md:px-12 md:pb-28 md:text-2xl)">
            <div className="z-10 w-[150px] md:w-[300px]">
              ...
              {isMobile && <div className="relative w-max text-gray-600 mt-3 mb-3" >
                <input onClick={openModal} placeholder="Search" className="w-32 bg-white text-black h-10 px-5 pr-10 rounded-full" type="text" />
        ...
        <div className="flex-col bg-[#E3E1DC] rounded-bl-[2.5rem] rounded-br-[2.5rem] pb-16 px-8 md:px-12 md:text-2xl">
          ...
          <div className="md:flex justify-between justify-items-end">
            <h2 className="text-i-primary font-bold text-2xl max-w-xs md:max-w-lg md:text-5xl mt-5">66+ Breeds for you to discover</h2>
            <h2 className="text-i-primary/50 inline-flex items-end text-xs md:text-lg font-extrabold">SEE MORE<span className=" ml-3"> <MdArrowForward /></span></h2>
          </div>
        ...
        <div className="flex flex-col md:flex-row mt-3 md:mt-12">
          <div className="flex flex-col md:p-4 md:w-6/12">
            ...
            <a href="#">
              <h2 className="text-i-primary/50 inline-flex items-center text-xs font-extrabold mt-12">READ MORE <span className="ml-3">{<MdArrowForward />}</span></h2>
            </a>
          </div>
        ...
        <div className="flex items-center md:flex-row md:justify-between py-10 px-6 h-44 md:h-24 bg-black mt-5 rounded-tl-[2.5rem] rounded-tr-[2.5rem]">
          <Image
            src='/img/logo2.svg'
            height="32"
            width="105" />
          <h2 className="text-white">cretad by starcode</h2>
        </div>
      </div>
